...
router.get('/festival/latest', jeuController.getAllByLatestFestivalPublic)
router.get('/festival/editeurs', jeuController.getEditeursByLatestFestival)
router.get('/festival/:festivalId', authenticate, authorizeAdmin, jeuController.getAllByFestivalWithDetails)
router.get('/festival/:festivalId/editeurs', jeuController.getEditeursByFestival)
